...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background: whitesmoke;">
        ...
        <main style="display: grid; grid-template-columns: 300px auto; margin: 30px; gap: 30px;">
          ...
          @include('page_modules.order_detail')
        </main>
        ...
        <script>
          $(document).ready(function(){
            ...
            $(document).on("click", ".view_btn", function(){
              ...
              $.ajax({
                type: "GET",
                url: "/view-order-detail/" + order_detail_id,
            ...
            $(document).on("click", ".edit_btn", function(){
              ...
              $.ajax({
                type: "GET",
                url: "/edit-order-detail/" + order_detail_id,
                success: function(res){
            ...
            $(document).on("click", ".delete_btn", function(){
              ...
              $.ajax({
                type: "GET",
                url: "/remove-order-detail/" + order_detail_id,
                success: function(res){
                  $("#remove_id").val(res.order_detail.id)
                }
              })
            })
